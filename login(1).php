...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Online Voting System</h3>
            ...
            <div class="card-body">
                <form action="" id="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="username" id="username" autofocus name="username" class="form-control form-control-sm rounded-0" required>
                    </div>
                    <div class="form-group">
        ...
        <center>
            <a href="./result.php" class="btn btn-primary btn-lg rounded-pill px-5" id="submit_btn" >View Result</a>
            <br>
