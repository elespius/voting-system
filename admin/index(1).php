...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |Online Voting System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'candidates')? 'active' : '' ?>" aria-current="page" href="./?page=candidates"><i class="fa fa-user-tie"></i> Candidate</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'voters')? 'active' : '' ?>" aria-current="page" href="./?page=voters"><i class="fa fa-user-friends"></i> Voters</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'result')? 'active' : '' ?>" aria-current="page" href="./?page=result"><i class="fa fa-poll-h"></i> Result</a>
                    </li>
            ...
            <div>
            <div class="dropdown">
                <?php if(isset($_SESSION['election'])): ?>
                    <span class="badge bg-success rounded-pill"><?php echo  isset($_SESSION['election']['title']) ? $_SESSION['election']['title'] : '' ?></span>
                <?php endif; ?>
