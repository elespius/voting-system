...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM `region_list` where region_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    <form action="" id="department-form">
        <input type="hidden" name="id" value="<?php echo isset($region_id) ? $region_id : '' ?>">
